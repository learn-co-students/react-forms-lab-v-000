...
function isValidPoem(poem) {
  ...
  const rightLength = poemLines.length === 3;
  const rightWordCount = countWords(poemLines[0]) === 5 && countWords(poemLines[1]) === 3 && countWords(poemLines[2]) === 5;
  return rightLength && rightWordCount;
}
