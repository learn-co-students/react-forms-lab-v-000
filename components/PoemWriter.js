...
const poemLines = poem.split('\n')  
      ...
      const isRightAmountLines = poemLines.length === 3;
      const isRightAmountWords = countWords(poemLines[0]) === 5 && countWords(poemLines[1]) === 3 && countWords(poemLines[2]) === 5
      
      return isRightAmountWords && isRightAmountLines;
    }
